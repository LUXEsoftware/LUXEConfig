...
## Run parameters to write in the run header. Use C/F/I ids to specify parameter type. E.g parameterName/F=0.42 to set a float parameter
SIM.meta.runParameters = []
